...
public class SupplierTableAdapter : Component
{
	...
	[DebuggerNonUserCode]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int? getLastSupplier()
	{
		object obj;
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.ColumnMappings.Add("PersonName", "PersonName");
		...
		this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "Name", DataRowVersion.Current, false, null, "", "", ""));
		this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@PersonName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "PersonName", DataRowVersion.Current, false, null, "", "", ""));
		this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@Address", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "Address", DataRowVersion.Current, false, null, "", "", ""));
		...
		this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "Name", DataRowVersion.Current, false, null, "", "", ""));
		this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@PersonName", SqlDbType.NVarChar, 50, ParameterDirection.Input, 0, 0, "PersonName", DataRowVersion.Current, false, null, "", "", ""));
		this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Address", SqlDbType.NVarChar, 100, ParameterDirection.Input, 0, 0, "Address", DataRowVersion.Current, false, null, "", "", ""));
		...
		this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@SupplierID", SqlDbType.Int, 4, ParameterDirection.Input, 10, 0, "SupplierID", DataRowVersion.Current, false, null, "", "", ""));
	}
	...
	[DebuggerNonUserCode]
	public virtual int Insert(string Name, string PersonName, string Address, long? Phone, int? AccCode, decimal? Balance)
	{
		int num1;
		if (Name == null)
		{
		...
		{
			this.Adapter.InsertCommand.Parameters[2].Value = PersonName;
		}
		if (Address == null)
		{
		...
		if (&Phone.HasValue)
		{
			this.Adapter.InsertCommand.Parameters[4].Value = &Phone.Value;
		}
		else
		{
		...
		if (&AccCode.HasValue)
		{
			this.Adapter.InsertCommand.Parameters[5].Value = &AccCode.Value;
		}
		else
		{
		...
		if (&Balance.HasValue)
		{
			this.Adapter.InsertCommand.Parameters[6].Value = &Balance.Value;
		}
		else
		{
	...
	[DebuggerNonUserCode]
	public virtual int Update(string Name, string PersonName, string Address, long? Phone, int? AccCode, int? oldAcc, int? SupplierID)
	{
		int num1;
		if (Name == null)
		{
		...
		{
			this.Adapter.UpdateCommand.Parameters[2].Value = PersonName;
		}
		if (Address == null)
		{
		...
		if (&Phone.HasValue)
		{
			this.Adapter.UpdateCommand.Parameters[4].Value = &Phone.Value;
		}
		else
		{
		...
		if (&AccCode.HasValue)
		{
			this.Adapter.UpdateCommand.Parameters[5].Value = &AccCode.Value;
		}
		else
		{
		...
		if (&oldAcc.HasValue)
		{
			this.Adapter.UpdateCommand.Parameters[6].Value = &oldAcc.Value;
		}
		else
		{
		...
		{
			this.Adapter.UpdateCommand.Parameters[7].Value = &SupplierID.Value;
		}
		else
		{
