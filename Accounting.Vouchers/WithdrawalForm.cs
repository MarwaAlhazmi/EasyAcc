...
public class WithdrawalForm : Form
{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(WithdrawalForm));
		...
		this.label1.ForeColor = Color.DarkKhaki;
		this.label1.Location = new Point(98, 10);
		this.label1.Name = "label1";
		this.label1.Size = new Size(102, 35);
		this.label1.TabIndex = 0;
		this.label1.Text = "سند صرف";
		this.pnlDeposit.BackColor = Color.DarkKhaki;
		...
		this.lblVNumber.Size = new Size(81, 13);
		this.lblVNumber.TabIndex = 0;
		this.lblVNumber.Text = "رقم سند الصرف";
	...
	{
		WithdrawalForm._mode = Mode.Edit;
		this.ResetControls();
		this.dtpDate.Text = "";
		this.pnlHeader.Enabled = true;
		this.pnlMain.Enabled = true;
